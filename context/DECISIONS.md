...
| 2026-09-20 | Represent context coverage as first-class scoped claims backed by Evidence provenance. | accepted | Strata and Time Tracking show coverage must be typed, multi-dimensional, and mechanically enforceable without parsing arbitrary Evidence content. | `research/decisions/DF-SDE-2026-0014` |
| 2026-09-20 | Represent reusable negative search observations as typed Evidence content paired with scoped coverage. | accepted | Coverage alone does not type target/method/state/exclusions/errors; a narrow payload enables mechanical absence-support checks without a universal ontology. | `research/decisions/DF-SDE-2026-0015` |
